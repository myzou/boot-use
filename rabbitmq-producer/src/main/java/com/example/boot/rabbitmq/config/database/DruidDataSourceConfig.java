package com.example.boot.rabbitmq.config.database;
...
public class DruidDataSourceConfig {
    ...
    private static Logger logger = LoggerFactory.getLogger(com.example.boot.rabbitmq.config.database.DruidDataSourceConfig.class);
