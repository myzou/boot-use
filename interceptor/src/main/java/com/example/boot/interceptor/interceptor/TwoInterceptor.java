package com.example.boot.interceptor.interceptor;

import com.example.boot.interceptor.pojo.WebJsonResult;
import com.example.boot.interceptor.utils.JsonUtils;
...
public class TwoInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object object) throws Exception {
        if (true) {
            returnErrorResponse(response, WebJsonResult.errorMsg("被two拦截..."));
        }
